    ...
    <SafeAreaView style={styles.subview}>
      ...
      <View style={styles.rowDirection}>
        ...
        <View style={styles.row}>
          <View style={styles.sizeShow}><Text style={styles.label}>
            Size</Text></View>
          <View style={styles.size}>
            <FlatList
              ...
              renderItem={({ item, index }) => (
                <View style={[{ backgroundColor: `${size === index ? "#126881" : "#F6F6F7"}` }, styles.diffSize]}>
                  <TouchableOpacity onPress={() => ShowSize(index)}  >
                    <Text style={{ color: `${size === index ? "#ffff" : "black"}` }}  >{item}</Text>
                  </TouchableOpacity>
                </View>
              )}
            />
        ...
        <View style={styles.star}>
          ...
          <View style={styles.color}>
            <FlatList
              ...
              keyExtractor={item => item.id}
              renderItem={({ item, index }) => (
                <TouchableOpacity onPress={() => ShowColor(index)}
        ...
        <View style={styles.quant}>
          ...
          <View style={styles.quantity}>
            <TouchableOpacity onPress={() => { Calculation("-") }}>
